...
//List 인터페이스란? 배열과 비슷한 구조를 가지면서 하위에 ArrayList, Linked Vector 클래스로 구성됨
//요소의 저장 순서가 유지, 중복저장 허용, 동적 할당(크기 지정을 안해도 됨),다양한 메소드 제공
...
public class ArrayListEx1 {
    public static void main(String[] args) {
        String[] data = {"138","145","122"};//이미 만들어진 배열
