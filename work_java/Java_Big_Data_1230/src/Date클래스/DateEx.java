...
//Data() : 1970년1월1일 0시0분0초에서 현재까지의 경과시간으로 시간계산(msec), 객체를 생성 후 사용
//simpleDataFormat : 운영체제로부터 얻어진 시간 정보를 우리가 원하는 포맷으로 변경해서 출력함(pattern 매칭을 사용)
public class DateEx {
    public static void main(String[] args) {
        Date now = new Date();
        // yyyy : 년도를 4자리로 표현
        // yy : 년도를 2자리로 표현
        // MM : 월을 2자리로 표시(반드시 대문자로 사용)
        // hh : 12시간제를 의미
        // HH : 24시간제를 의미
        // mm : 분을 표시(두자리)
        // W : 월의 몇번쨰 주인지 표시
        ...
        f6 = new SimpleDateFormat("오늘은 M월의 W번재 주, d번째 날 입니다");
