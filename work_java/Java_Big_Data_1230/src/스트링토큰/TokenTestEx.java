...
public class TokenTestEx {
    public static void main(String[] args) {
        ...
        String name = scanner.nextLine();//문자열을 개행문자를 만날때까지 입력받음
//        StringTokenizer st = new StringTokenizer(name, "/");//배열과 구분자를 객체 생성시 넣어줌
//        String[] nameStr = new String[st.countTokens()];//토큰의 개수 만큼의 문자열 배열생성
//        while(st.hasMoreTokens()){//남아 있는 토큰이 있는 동안 박복문 수행
