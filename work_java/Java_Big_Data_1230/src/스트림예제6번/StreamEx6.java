...
//스트림 최종 연산 : 중개 연산을 통해 변환된 스트림은 마지막으로 최종연산을 통해 요소를 소모해 결과를 출력
public class StreamEx6 {
    public static void main(String[] args) {
        ...
        //reduce() : 첫번째 요소와 두번째 요소를 가지고 연산을 수행 후, 그 결과가 세번째 요소를 가지고 다시 연산
        ...
        DoubleStream stream12 = DoubleStream.of(30.3,90.9,70.11,10,17);
